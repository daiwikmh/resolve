...
abstract contract BaseHook is IHooks, ImmutableState {
    ...
    function beforeAddLiquidity(
        ...
        if (!getHookPermissions().beforeAddLiquidity) revert HookNotImplemented();
    ...
    function afterAddLiquidity(
        ...
        if (!getHookPermissions().afterAddLiquidity) revert HookNotImplemented();
    ...
    function beforeRemoveLiquidity(
        ...
        if (!getHookPermissions().beforeRemoveLiquidity) revert HookNotImplemented();
    ...
    function afterRemoveLiquidity(
        ...
        if (!getHookPermissions().afterRemoveLiquidity) revert HookNotImplemented();
